...
const AdminDashboard = () => {
    ...
    return (
        <div className='animate-page overflow-hidden'>
            ...
            <div className=' py-1.5 sm:py-3 rounded-xl bg-white w-full md:w-[95%] mx-auto overflow-x-auto'>
                <div className='flex items-center gap-5 w-full  pl-3 pr-3'>

                    <div className='bg-[#fef8e8] min-w-[150px] md:min-w-[180px] w-full lg:w-[20%]  flex flex-col items-center h-full py-4  lg:py-5 justify-center rounded-lg shadow-sm scale-95 hover:scale-100 transition-transform gap-2 sm:gap-5 border-2 border-[#ede4bb] '>
                    ...
                    <div className='bg-[#ededfe] min-w-[150px] md:min-w-[180px]  w-full lg:w-[20%]  flex flex-col items-center py-4  lg:py-5 justify-center rounded-lg shadow-sm scale-95 hover:scale-100 transition-transform gap-2 sm:gap-5 border-2 border-[#dad7f6] '>
                    ...
                    <div className='bg-[#e7f9f9] min-w-[150px] md:min-w-[180px]  w-full lg:w-[20%]  flex flex-col items-center py-4  lg:py-5 justify-center rounded-lg shadow-sm scale-95 hover:scale-100 transition-transform gap-2 sm:gap-5 border-2 border-[#c4e9e4] '>
                    ...
                    <div className='bg-[#eaf9ef] min-w-[150px] md:min-w-[180px]  w-full lg:w-[20%]  flex flex-col items-center py-4  lg:py-5 justify-center rounded-lg shadow-sm scale-95 hover:scale-100 transition-transform gap-2 sm:gap-5 border-2 border-[#c9e4d6] '>
                    ...
                    <div className='bg-[#fff1f6] min-w-[150px] md:min-w-[180px]  w-full lg:w-[20%]  flex flex-col items-center py-4  lg:py-5 justify-center rounded-lg shadow-sm scale-95 hover:scale-100 transition-transform gap-2 sm:gap-5 border-2 border-[#efd4dd] '>
            ...
            <div className='text-black mx-2 lg:mx-5 my-3 font-semibold text-xl flex items-center gap-1'>Swap charts <ChartNoAxesCombined color='#00d38b' size={20} /> for best view</div>
