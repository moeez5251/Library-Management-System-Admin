    ...
    return (
        <div className='animate-page overflow-hidden'>
            <div className='flex items-center justify-between mx-1 md:mx-4 my-2'>
                <h1 className='font-semibold text-base md:text-xl'>Welcome Admin</h1>
                <div className='flex items-center gap-2'>
                    <div className='font-semibold text-sm md:text-lg'>Quick Actions :</div>
                    <button onClick={() => { router.push("/admin/managebooks/add") }} className='bg-[#6841c4] text-white px-2 md:px-3 py-2  rounded-lg cursor-pointer transition-transform scale-90 hover:scale-100 font-normal'>Add New Book</button>
                </div>
            </div>
            <div className='  py-3 rounded-xl bg-white w-full md:w-[95%] mx-auto overflow-x-auto'>
                <div className='flex items-center gap-5 w-full pl-3 pr-3'>

                    <div className='bg-[#fef8e8] min-w-[150px] md:min-w-[180px] w-full lg:w-[20%]  flex flex-col items-center py-5 justify-center rounded-lg shadow-sm scale-95 hover:scale-100 transition-transform gap-5 border-2 border-[#ede4bb] '>
                    ...
                    <div className='bg-[#ededfe] min-w-[150px] md:min-w-[180px]  w-full lg:w-[20%]  flex flex-col items-center py-5 justify-center rounded-lg shadow-sm scale-95 hover:scale-100 transition-transform gap-5 border-2 border-[#dad7f6] '>
                    ...
                    <div className='bg-[#e7f9f9] min-w-[150px] md:min-w-[180px]  w-full lg:w-[20%]  flex flex-col items-center py-5 justify-center rounded-lg shadow-sm scale-95 hover:scale-100 transition-transform gap-5 border-2 border-[#c4e9e4] '>
                    ...
                    <div className='bg-[#eaf9ef] min-w-[150px] md:min-w-[180px]  w-full lg:w-[20%]  flex flex-col items-center py-5 justify-center rounded-lg shadow-sm scale-95 hover:scale-100 transition-transform gap-5 border-2 border-[#c9e4d6] '>
                    ...
                    <div className='bg-[#fff1f6] min-w-[150px] md:min-w-[180px]  w-full lg:w-[20%]  flex flex-col items-center py-5 justify-center rounded-lg shadow-sm scale-95 hover:scale-100 transition-transform gap-5 border-2 border-[#efd4dd] '>
            ...
            <div className='flex  mx-4 my-2 gap-8 lg:gap-3 flex-col lg:flex-row items-center lg:items-start justify-center swapy'>
                <div data-swapy-slot="a" className='w-full sm:w-[90%] lg:w-[60%]'>
                    <ChartTooltipIndicatorLine />
                </div>
                <div data-swapy-slot="b" className='w-full sm:w-[90%] lg:w-[40%]'>
